    ...
    <div className="min-h-screen bg-background text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold">Modalidad Presencial</h1>
        ...
        <div className="bg-white/4 backdrop-blur-xl border border-white/8 rounded-2xl p-8 mb-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              Las clases se llevarán a cabo en el <strong className="text-white">Edificio Rojas</strong>,
              entre la <strong className="text-white">calle 1 y 2, 3er piso</strong>.
            </p>
          </div>
        ...
        <div className="bg-white/4 backdrop-blur-xl border border-white/8 rounded-2xl p-8 text-center">
          <h3 className="text-xl font-semibold text-white mb-4">¿Cómo llegar?</h3>
